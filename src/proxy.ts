...
export async function proxy(request: NextRequest) {
  ...
  const isPublicRoute = pathname === '/' || pathname === '/arena-eleitoral' || pathname === '/analise-redes' || pathname.startsWith('/mapeamento-instagram') || pathname === '/selfie-video' || pathname.startsWith('/selfie-video/monitor') || pathname.startsWith('/admin/video-modelo') || pathname.startsWith('/apresentacao');
