...
export async function proxy(request: NextRequest) {
  ...
  const isPublicRoute = pathname === '/' || pathname.startsWith('/arena') || pathname === '/analise-redes' || pathname.startsWith('/mapeamento-instagram') || pathname.startsWith('/selfie-video') || pathname.startsWith('/admin/video-modelo') || pathname.startsWith('/apresentacao') || pathname === '/privacidade' || pathname.startsWith('/supia') || pathname.startsWith('/voz-teste');
