...
const SLUG = 'ricardomarques';
const DISPLAY_NAME = 'Ricardo Marques';
const WHATSAPP_NUMBER = (process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '').replace(/\D/g, '');
const WHATSAPP_GREETING = encodeURIComponent('Quero receber meu vídeo');

export default function SelfieCaptureV2({ logoUrl }: { logoUrl: string | null }) {
  const r = useSelfieRecorderV2({ slug: SLUG });

  // Logo grande dinâmico por político (fallback no PL). O header continua fixo no PL.
  const heroLogo = logoUrl || '/logo-pl.png';
          ...
          <div className="flex-1 flex flex-col justify-center px-6 py-8 max-w-md mx-auto w-full relative">
            ...
            <div className="text-center mb-8">
              <div className="mb-6">
                ...
                <img
                  src={heroLogo}
                  alt={logoUrl ? DISPLAY_NAME : 'PL - Partido Liberal'}
                  width={160}
                  height={160}
