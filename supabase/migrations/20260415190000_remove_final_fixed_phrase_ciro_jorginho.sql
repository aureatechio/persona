-- Revert the "FRASE FINAL FIXA" addition from Ciro and Jorginho prompts.
-- Restores the prompts to the original versions (terminating at
-- "Conte comigo nessa caminhada!") as provided by the user.
-- Flávio's prompt is untouched.
